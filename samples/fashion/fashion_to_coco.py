...
# DATA_DIR = "D:/Datasets/tinyFashion/train/images/"
DATA_DIR = "D:/Datasets/tinyFashion/val/images/"
list_images = os.listdir(DATA_DIR)

for num, each in enumerate(list_images):
    image_name = DATA_DIR + each
    json_name = DATA_DIR.replace("images", "annotations") + each.replace(".jpg", ".json")
...
# json_name = 'fashion_train.json'
json_name = 'fashion_val.json'
